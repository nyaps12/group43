...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light"> Manage /</span> Permission
</h4>

<div class="row">
  <div class="col-md-12">
    <ul class="nav nav-pills flex-column flex-md-row mb-4">
    <li class="nav-item"><a class="nav-link" href="{{url('roles')}}"><i class="ti-xs ti ti-users me-1"></i> Roles</a></li>
      <li class="nav-item"><a class="nav-link active" href="{{url('permission')}}"><i class="ti-xs ti ti-bell me-1"></i> Permission</a></li>
    </ul>
    <div class="card">
